      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Studio42Dev.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Studio42Dev, accessible from{" "}
            <a
              href="https://studio42dev.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://studio42dev.com
            </a>
          </p>
        </li>
        <li>
